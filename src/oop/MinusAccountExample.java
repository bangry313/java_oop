...
public class MinusAccountExample {
	...
	public static void main(String[] args) {
		MinusAccount ma;
		ma = new MinusAccount("1111-2222", "김기정", 1111, 10000, 10000000, "2023.1.4");
		...
		Account account1 = new Account("1111", "김기정", 111, 10000);
		Account account2 = new Account("1111", "김기정", 111, 10000);
