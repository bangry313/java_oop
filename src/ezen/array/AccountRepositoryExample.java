...
//		AccountRepository repository = new AccountRepository();
		...
		// 입출금 신규계좌 생성 테스트
		Account account = new Account("1111-2222", "김기정", 1111, 1000000);
		...
		// 마이너스 신규계좌 등록
		MinusAccount ma = 
		  new MinusAccount("2222-1111", "김대출", 1111, 10000, 10000000, "2023.1.10");
		// 자동형변환 적용 (Up casting)
		repository.addAccount(ma);
		repository.addAccount(new MinusAccount("2222-2222", "김기정", 1111, 10000, 10000000, "2023.1.10"));
		...
		Account findAccount = repository.findByNumber("1111-2223");
		if (findAccount != null) {
		...
		repository.addAccount(new Account("1111-7777", "박찬울", 1111, 100000));
