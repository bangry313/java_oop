 ...
 * @Date   2023. 1. 16.
 */
public class AccounFrame extends Frame {
	...
	static {
		...
		try {
			prop.load(AccounFrame.class.getResourceAsStream("config.properties"));
	...
	public AccounFrame(String title, AccountRepository repository) {
...
//		AccounFrame frame5 = new AccounFrame("AWT 컴포넌트틀");
//		frame5.initLayout();
